...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .firma-img { position: absolute; bottom: 50mm; right: 4mm; height: 38.4mm; z-index: 3; opacity: 0.9; }
    .contenido { position: absolute; inset: 0; z-index: 2; display: flex; flex-direction: column; align-items: center; padding: 0 25mm; transform: translateY(30mm); }
    ...
    .firma-bloque { position: absolute; bottom: 38mm; right: 12mm; text-align: center; width: 82mm; z-index: 3; }
